...
Status: historical
Authority: Preserved adaptive-planning milestone vision only
Superseded by: [Canonical target requirements](../requirements.md)
Related: [Current implementation](../status/current-implementation.md), [active roadmap](../roadmap.md)
Last reviewed: 2026-08-09

> **Historical document:** Do not use this document as current product requirements or implementation order. It describes the adaptive portfolio slice as it was framed in August 2026, not the final conversational product.

Original status: canonical product direction
Original update: 2026-08-08
